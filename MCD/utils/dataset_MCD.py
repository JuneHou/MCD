...
class VQAFeatureDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.name == 'train':
            if config.css:
                train_hint = torch.tensor(self.train_hintscore[str(question_id)])
                ...
                type_mask = 0
                notype_mask = 0
            return features, question, target, target_margin, bias, question_id, freq_margin0, q_type, train_hint, type_mask, notype_mask, ques_mask
        else:
