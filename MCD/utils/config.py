...
main_path       = '/data/jxq/Bia_Model_data/'
qa_path         = main_path
...
ids_path    = '/data/jxq/code/RMLVQA/data2/abhipsa/AdaVQA/data/'
...
if cp_data:
    if version == 'v2':
        cache_root          = '/data/jxq/Bia_Model_data/cp-cache/'
    else:
        cache_root = '/data/jxq/Bia_Model_data/cpv1-cache/'
elif version == 'ok':
    cache_root = '/data/jxq/Bia_Model_data/ok-cache/'
else:
    cache_root          = '/data/jxq/Bia_Model_data/cache/'
